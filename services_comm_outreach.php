...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US" dir="ltr">
	<head>
		...
		<title>ACDSS | Services | Community Outreach Division</title>
						...
						<div class="art-content-layout-row">
							...
							<font color="#F1EDC2">
								<article class="art-post art-article">
									<h3 class="art-postheader"><font color="white">Community Outreach Division</font></h3>
									...
									<?php
										...
										$service_query = mysql_query("SELECT * FROM services WHERE division='Community Outreach Division' AND status='Active'") or die("This webpage is not available.<br />".mysql_error());
										if($service_query)
										{
