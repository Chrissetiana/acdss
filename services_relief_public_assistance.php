...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US" dir="ltr">
	<head>
		...
		<title>ACDSS | Services | Relief and Public Assistance Division</title>
						...
						<div class="art-content-layout-row">
							...
							<font color="#F1EDC2">
								<article class="art-post art-article">
									<h3 class="art-postheader"><font color="white">Relief and Public Assistance Division</font></h3>
									<div class="art-postcontent art-postcontent-0 clearfix">
										<p>A total of 5,610 received this assistance this 2011. These were victims of disasters/calamities. <a href="http://www.antipolo.gov.ph/cswd.php"> Read more... </a></p>
										<br /><br /><br />
									</div>
									<?php
										include("connection.php");

										$service_query = mysql_query("SELECT * FROM services WHERE division='Relief and Public Assistance Division' AND status='Active'") or die("This webpage is not available.<br />".mysql_error());
										if($service_query)
										{
