...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US" dir="ltr">
	<head>
		...
		<title>ACDSS | Admin | Delete</title>
						...
						<div class="art-content-layout-row">
							<div class="art-layout-cell art-content clearfix">
								<article class="art-post art-article">
									<h2 class="art-postheader">Delete Record</h2>
									<div class="art-postcontent art-postcontent-0 clearfix">
										<?php
											...
											$table_archive = mysql_query("UPDATE $table_name SET status = 'Inactive' WHERE $table_name.id=$id LIMIT 1") or die("Cannot delete record.<br />".mysql_error());
											if($table_archive)
											{
												echo '<script language="javascript">';
													echo 'alert("Record with id '.$id.' deleted.");';
											...
											{
												echo '<script language="javascript">';
													echo 'alert("Cannot delete record!");';
													echo 'location.replace("view.php");';
												echo '</script>';
											}
										?>
